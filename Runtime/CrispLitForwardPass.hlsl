...
Varyings CrispLitPassVertex(Attributes input)
{
...
)
{
...
#if !defined(_SPECULARAA_OFF)
    surfaceData.smoothness = CrispApplySpecularAA(input.normalWS, surfaceData.smoothness, _SpecAAVariance, _SpecAAThreshold);
#endif
    ...
    half4 color = CrispFragmentPBR(inputData, surfaceData);
